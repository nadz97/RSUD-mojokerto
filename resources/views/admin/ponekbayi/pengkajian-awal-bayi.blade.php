        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="tab" id="tab-1">
                    ...
                    <div class="row mt-4">
                        <h4>Status Sosial. Ekonomi, Spiritual Suku / Budaya, Nilai Kepercayaan</h4>
                    </div>
                    <hr>
                    <div class="row mt-4">
                        <div class="col">
                        ...
                        <div class="col">
                            <div class="form-floating">
                                <input class="form-control" type="text" list="opsi2" id="combobox2" placeholder="Pendidikan Suami/Istri"/>
                                <datalist id="opsi2">
                                    <option>SD</option>
                                    <option>SMP</option>
                                    <option>SMA</option>
                                ...
                                <label for="combobox2">Pendidikan Suami/Istri</label>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-floating">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col">
                            <div class="form-floating">
                                <input class="form-control" type="text" list="opsikeper" id="kepercayaan" placeholder="Nilai nilai kepercayaan pasien/keluarga"/>
                                <datalist id="opsikeper">
                                    <option>Tidak</option>
                                    <option>Ada</option>
                                </datalist>
                                <label style="font-size:14px;" for="kepercayaan">Nilai nilai kepercayaan pasien/keluarga</label>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-floating">
                                <input class="form-control" type="text" list="opsilogis" id="psikologis" placeholder="Status Psikologis Orang Tua"/>
                                ...
                                <label for="psikologis">Status Psikologis Orang Tua</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="usiagestasi" placeholder="Usia Gestasi">
                                <label for="usiagestasi">Usia Gestasi</label>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col ">
                            <form id="radioform">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="optradio" id="radiono" checked>Tidak
                                </label>
                                <label class="radio-inline ml-3">
                                    <input type="radio" name="optradio" id="radioyes">Ya
                                </label>
                            </form>
                        </div>
                        <div class="col ">
                            <div class="form-floating">
                                <input class="form-control" type="text" list="opsikonsumsi" id="obatkonsumsi" placeholder="Obat yang dikonsumsi selama kehamilan"/>
                                <datalist id="opsikonsumsi">
                                    <option>Tidak ada</option>
                                    <option>Ada, jenis</option>
                                </datalist>
                                <label style="font-size:12px;" for="kepercayaan">Obat yang dikonsumsi selama kehamilan</label>
                            </div>
                        </div>
                        <div class="col ">
                            <div class="form-floating">
                                ...
                                <datalist id="opsikonsumsi">
                                    ...
                                    <option>Minum Jamu</option>
                                    <option>Minuman Beralkohol</option>
                                    <option>DLL</option>
                                </datalist>
                                <label style="font-size:14px;" for="kepercayaan">Kebiasan ibu</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-md-4">
                            <label for="riwayatpersalinan">Riwayat Persalinan</label>
                            <select id="riwayatpersalinan" class="form-control">
                                <option selected>Open this select menu</option>
                                <option value="SC">SC</option>
                                <option value="Spontan">Spontan Kepala/Bokong</option>
                                <option value="VE">VE</option>
                                <option value="FORCEP">FORCEP</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <label for="opsivolume">Volume</label>
                            <select id="opsivolume" class="form-control">
                                <option value="">Normal</option>
                                <option value="">Oligohidramnion</option>
                                <option value="">Polihidramnion</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="apgar" placeholder="Apgar Score">
                                <label for="apgar">Apgar Score</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-floating">
                                <input class="form-control" type="text" list="opsikebutuhan" placeholder="Kebutuhan"/>
                                <datalist id="opsikebutuhan">
                                    <option>Jernih</option>
                                    <option>Hijau encer / kental</option>
                                    <option>Meconium</option>
                                    <option>Darah</option>
                                    <option>Putih Keruh</option>
                                    <option>Lain-lain</option>
                                </datalist>
                    ...
                    <div class="row form-group">
                        <div class="col-md-4">
                            <div class="form-floating">
                                <div class="input-group">
                                    ...
                                    <span class="ml-3" style="vertical-align:middle; text-align:center; line-height: 54px;"> gr </span>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-floating">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="tensi_darah" name="tensi_darah">
                                    <span class="ml-3" style="vertical-align:middle; text-align:center; line-height: 54px;"> cm </span>
                                </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-4">
                                ...
                                <input class="form-control" type="text" list="opsipenyakit"/>
                    ...
                    <div class="row mt-4">
                        <div class="col-md-4">
                            ...
                            <label for="penyakit">Riwayat Alergi Obat / Makanan</label>
                            <input class="form-control" type="text" list="opsipenyakit"/>
                                <datalist id="opsipenyakit">
                                    <option>Tidak ada</option>
                                    <option>Ada, sebutkan</option>
                                </datalist>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="d-flex flex-column">
                                <div class="p-2">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="darah" placeholder="Tekanan Darah">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="p-2">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="badan" placeholder="Panjang Badan">
                        ...
                        <div class="col">
                            ...
                            <div class="d-flex flex-column">
                                <div class="p-2">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="kepala" placeholder="Lingkar kepala">
                                        <label for="kepala">Lingkar Kepala</label>
                                    </div>
                                </div>
                                <div class="p-2">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="dada" placeholder="Lingkar dada">
                                        <label for="dada">Lingkar Dada</label>
                                    </div>
                                </div>
                                <div class="p-2">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="perut" placeholder="Lingkar Perut">
                ...
                <div class="tab m-4" id="tab-2">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <select class="form-control" aria-label="Default select example">
                                        <option selected>Open this select menu</option>
                                        <option value="0">< 60 x/menit</option>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <ul>
                                ...
                                <li>4 - 5 Nyeri Sedang</li>
                                <li>6 - 7 Nyeri Berat</li>
                            </ul>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="row-md-3">
                            <h4>Sistem Pernafasan</i></h4>
                        </div>
                        <form class="row mt-4">
                            <div class="col-md-3">
                                <p>Spontan</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col form-group">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="bibir" id="lembab" value="lembab">
                                <label class="form-check-label" for="lembab">Lembab</label>
                            </div>
                            <div class="form-check form-check-inline ml-3">
                                <input class="form-check-input" type="radio" name="bibir" id="kering" value="kering">
                                <label class="form-check-label" for="kering">Kering</label>
                            </div>
                            <div class="form-check form-check-inline ml-3">
                                <input class="form-check-input" type="radio" name="bibir" id="labioschizis" value="labioschizis">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col">
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="kesadaran" id="composmentis" value="composmentis">
                                    <label class="form-check-label" for="composmentis">Composmentis</label>
                                </div>
                                <div class="form-check form-check-inline ml-3">
                                    <input class="form-check-input" type="radio" name="kesadaran" id="composmentis" value="apatis">
                                    <label class="form-check-label" for="apatis">Apatis</label>
                                </div>
                                <div class="form-check form-check-inline ml-3">
                                    <input class="form-check-input" type="radio" name="kesadaran" id="composmentis" value="somnolent">
                                    <label class="form-check-label" for="somnolent">Somnolent</label>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="kesadaran" id="soporo" value="soporo">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col">
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="pupil_mata" id="isokor" value="isokor">
                                    <label class="form-check-label" for="isokor">Isokor</label>
                                </div>
                                <div class="form-check form-check-inline ml-4">
                                    <input class="form-check-input" type="radio" name="pupil_mata" id="anisokor" value="anisokor">
                                    <label class="form-check-label" for="anisokor">Anisokor</label>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="pupil_mata" id="reaksi" value="Ada reaksi terhadap cahaya">
                                    <label class="form-check-label" for="reaksi">Ada reaksi terhadap cahaya</label>
                                </div>
                                <div class="form-check form-check-inline ml-4">
                                    <input class="form-check-input" type="radio" name="pupil_mata" id="noreaksi" value="Tidak reaksi terhadap cahaya">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col">
                            <div class="form-check form-check-inline ">
                                <input class="form-check-input" type="radio" name="tangisan" id="kuat" value="kuat">
                                <label class="form-check-label" for="kuat">Kuat</label>
                            </div>
                            <div class="form-check form-check-inline ml-3">
                                <input class="form-check-input" type="radio" name="tangisan" id="melengking" value="melengking">
                                <label class="form-check-label" for="melengking">melengking</label>
                            </div>
                            <div class="form-check form-check-inline ml-3">
                                <input class="form-check-input" type="radio" name="tangisan" id="merintih" value="merintih">
                                <label class="form-check-label" for="merintih">merintih</label>
                            </div>
                            <div class="form-check form-check-inline ml-3">
                                <input class="form-check-input" type="radio" name="tangisan" id="tidakMenangis" value="tidak menangis">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col">
                            <div class="form-check form-check-inline ">
                                <input class="form-check-input" type="radio" name="ubun_ubun" id="datar" value="datar">
                                <label class="form-check-label" for="datar">datar</label>
                            </div>
                            <div class="form-check form-check-inline ml-3">
                                <input class="form-check-input" type="radio" name="ubun_ubun" id="cekung" value="cekung">
                                <label class="form-check-label" for="cekung">cekung</label>
                            </div>
                            <div class="form-check form-check-inline ml-3">
                                <input class="form-check-input" type="radio" name="ubun_ubun" id="cembung" value="cembung">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col">
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="kepala" id="tidakKelainan" value="tidak kelainan">
                                    <label class="form-check-label" for="tidakKelainan">tidak kelainan</label>
                                </div>
                                <div class="form-check form-check-inline ml-3">
                                    <input class="form-check-input" type="radio" name="kepala" id="anencephal" value="anencephal">
                                    <label class="form-check-label" for="anencephal">Anencephal</label>
                                </div>
                                <div class="form-check form-check-inline ml-3">
                                    <input class="form-check-input" type="radio" name="kepala" id="ceptal" value="Ceptal Hematoma">
                                    <label class="form-check-label" for="ceptal">Ceptal Hematoma</label>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="kepala" id="soporo" value="soporo">
                                    <label class="form-check-label" for="soporo">Hidrosepalus</label>
                                </div>
                                <div class="form-check form-check-inline ml-4">
                                    <input class="form-check-input" type="radio" name="kepala" id="caput" value="Caput Succedenium">
                                    <label class="form-check-label" for="caput">Caput Succedenium</label>
                                </div>
                                <div class="form-check form-check-inline ml-4">
                                    <input class="form-check-input" type="radio" name="kepala" id="perdarahan" value="Perdarahan venticular">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col">
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="tonus_otot" value="tidak kelainan">
                ...
                <div class="tab m-4" id="tab-3">
                        ...
                        <div class="row">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="form-group col">
                                    <div class="col">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="turgor_kulit" id="kemerahan" value="kemerahan">
                                            <label class="form-check-label" for="kemerahan">kemerahan</label>
                                        </div>
                                        <div class="form-check form-check-inline ml-3">
                                            <input class="form-check-input" type="radio" name="turgor_kulit" id="pucat" value="pucat">
                                            <label class="form-check-label" for="pucat">pucat</label>
                                        </div>
                                        <div class="form-check form-check-inline ml-3">
                                            <input class="form-check-input" type="radio" name="turgor_kulit" id="ikterus" value="ikterus">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="form-group col">
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="turgor_kulit" id="elastis" value="elastis">
                                        <label class="form-check-label" for="elastis">elastis</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="radio" name="turgor_kulit" id="tidakElastis" value="tidak elastis">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="form-group col">
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="integritas_kulit" id="utuh" value="utuh">
                                        <label class="form-check-label" for="utuh">utuh</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="radio" name="integritas_kulit" id="kering" value="kering">
                                        <label class="form-check-label" for="kering">kering</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="radio" name="integritas_kulit" id="rash" value="rash">
                                        <label class="form-check-label" for="rash">rash</label>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="integritas_kulit" id="bulae" value="bulae">
                                        <label class="form-check-label" for="bulae">bulae</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="radio" name="integritas_kulit" id="pustula" value="pustula">
                                        <label class="form-check-label" for="pustula">pustula</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="radio" name="integritas_kulit" id="ptechiae" value="ptechiae">
                                        <label class="form-check-label" for="ptechiae">ptechiae</label>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="integritas_kulit" id="lesi" value="lesi mengelupas">
                                        <label class="form-check-label" for="lesi">lesi mengelupas</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="radio" name="integritas_kulit" id="lesi" value="lesi kemerahan">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="form-group col">
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="tali_pusat" id="ada" value="ada">
                                        <label class="form-check-label" for="ada">ada</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="radio" name="tali_pusat" id="tidak ada" value="tidak ada">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="form-group col">
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="puntung_umblical" id="kering" value="kering">
                                        <label class="form-check-label" for="kering">kering</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="radio" name="puntung_umblical" id="basah" value="basah">
                                        <label class="form-check-label" for="basah">basah</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="radio" name="puntung_umblical" id="busuk" value="bau busuk">
                                        <label class="form-check-label" for="busuk">bau busuk</label>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="puntung_umblical" id="kemerahan" value="kemerahan">
                                        <label class="form-check-label" for="kemerahan">kemerahan</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="radio" name="puntung_umblical" id="pus" value="pus">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="form-group col">
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="abdomen" id="tidakadakelainan" value="tidak ada kelainan">
                                        <label class="form-check-label" for="tidakadakelainan">tidak ada kelainan</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="radio" name="abdomen" id="lukaoperasi" value="luka operasi">
                                        <label class="form-check-label" for="lukaoperasi">luka operasi</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="radio" name="abdomen" id="Kolostomi" value="Kolostomi">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="vagina" id="opsivg" value="bersih">
                                        <label class="form-check-label" for="opsivg">bersih</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="radio" name="vagina" id="opsivg2" value="kotor">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="vagina" id="opsips" value="ya">
                                        <label class="form-check-label" for="opsips">ya</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="radio" name="vagina" id="opsips2" value="tidak">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="vagina" id="opsiktt" value="ya">
                                        <label class="form-check-label" for="opsiktt">ya</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="radio" name="vagina" id="opsiktt2" value="tidak">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="vagina" id="opsilb" value="ya">
                                        <label class="form-check-label" for="opsilb">ya</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="radio" name="vagina" id="opsilb2" value="tidak">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="vagina" id="opsipre" value="bersih">
                                        <label class="form-check-label" for="opsipre">bersih</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="radio" name="vagina" id="opsipre2" value="kotor">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="vagina" id="opsihip" value="ya">
                                        <label class="form-check-label" for="opsihip">ya</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="radio" name="vagina" id="opsihip2" value="tidak">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="skrining_gizi" id="opsigizi" value="ASI">
                                        <label class="form-check-label" for="opsigizi">ASI</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="radio" name="skrining_gizi" id="opsigizi2" value="PASI">
                                        <label class="form-check-label" for="opsigizi2">PASI</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="radio" name="skrining_gizi" id="opsigizi3" value="lainlain">
                                        <label class="form-check-label" for="opsigizi2">Lain-lain</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <input class="form-control" id="optional" placeholder="Lain-lain" type="text">
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            <h3 class="centeredtext">PENGKAJIAN DOKTER</h3>
                        </div>
                        <div class="row">
                            <div class="col-md-2">
                                <p>S (Anamnesa) :</p>
