                                ...
                                <tr>
                                    <td>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="yang_diedukasi2" value="">
                                    ...
                                    <td>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="materi_ponek2" value="">
                                            <label class="form-check-label">
                                                Diskusi
                                            </label>
                                        </div>
                        ...
                        <table  class="table table-bordered">
                            <tbody>
                                <tr>
                                    ...
                                    <td style="background: #edf2f4">
                                        <input type="date" class="form-control" name="catatan_edukasi2">
                                    </td>
                                </tr>
                                <tr>
                                    <td style="background: #f6f4d2">
                                    ...
                                    <td style="background: #edf2f4">
                                        <input type="text" class="form-control" name="catatan_edukasi2" placeholder="Isi Bila Perlu">
                                    </td>
                                </tr>
                                <tr>
                                    <td style="background: #f6f4d2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <div class="col">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="" name="catatan_edukasi2">
                                                    <label class="form-check-label">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="" name="catatan_edukasi2" id="lny">
                                                    <label class="form-check-label">
                                                        Lainnya
                                                    </label>
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="" name="catatan_edukasi2" id="ktrl">
                                                    <label class="form-check-label">
                                                        Kontrol ke....
                                                    </label>
                                                    <input type="text" class="form-control" id="input_kontrol">
                                                </div>
                                            </div>
                                        </div>
                                    </td>
...
<script>
    $(function(){
        ...
        $("#lny").on("click",function() {
            $("#input_lain1").toggle(this.checked);
            $('#input_lain1').val('');
        });
        ...
        $("#ktrl").on("click",function() {
            $("#input_kontrol").toggle(this.checked);
            $('#input_kontrol').val('');
        });
