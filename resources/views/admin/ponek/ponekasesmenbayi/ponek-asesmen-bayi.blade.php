        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="tab m-4" id="tab-3">
                    <div class="row mb-3">
                        <h4 class="text-center">Keadaan Umum dan Pemeriksaan Fisik</h4>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
                            <p>a. Keadaan Tali Pusat</p>
                        </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <textarea class="form-control" id="terapi" rows="6"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <textarea class="form-control" id="terapi" rows="4"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3">
                    ...
                    <div class="row mt-4">
                        <h4>RENCANA PULANG . DISCHARGE PLANNING</h4>
                    </div>
                    <div class="row">
                        <textarea class="form-control" id="terapi" rows="5"></textarea>
